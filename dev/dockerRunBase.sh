...
export ELK_KIBANA_HOST=${ELK_KIBANA_HOST:"kibana.${ADMIN_DOMAIN}:443"}
export ELK_KIBANA_USERNAME=${ELK_KIBANA_USERNAME:"${ELK_ELASTICSEARCH_USERNAME}"}
export ELK_KIBANA_PASSWORD=${ELK_KIBANA_PASSWORD:"${ELK_ELASTIC_PASSWORD}"}
export ELK_ELASTIC_HOST=${ELK_ELASTIC_HOST:"elastic.${ADMIN_DOMAIN}:443"}
export ELK_ELASTIC_USERNAME=${ELK_ELASTIC_USERNAME:"${ELK_ELASTICSEARCH_USERNAME}"}
export ELK_ELASTIC_PASSWORD=${ELK_ELASTIC_PASSWORD:"${ELK_ELASTIC_PASSWORD}"}
